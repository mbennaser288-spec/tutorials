...
|---|---|---|
| `week1` | Java basics | Hello World and student grade program |
| `week2` | Classes and constructors | Student attributes, constructor, and methods |
| `week3-4` | Inheritance and overriding | Person, Student, and Lecturer classes |
| `week5` | Encapsulation | Private student data, getters, setters, and written answers |
| `week6` | Inheritance | Employee and Lecturer with subject and department |
| `week7` | Abstraction | Smart-home appliance classes |
...
https://github.com/mbennaser288-spec/tutorials
